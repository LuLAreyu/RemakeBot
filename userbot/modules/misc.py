...
async def sleepybot(time):
    ...
    await time.edit("`I am sulking and snoozing Huaaa..`")
    if BOTLOG:
...
async def repo_is_here(wannasee):
    ...
    await wannasee.edit(
        "╔╦╦╦╦╦╦╦╦╦╦╦╦╦╦╦╦╦╗\n \n[┣━─━─[ LuL - UBot]─━─━┫](https://github.com/LuLAreyu/RemakeBot) \n \n[┣━─━─[ Yang Fork ]─━─━┫](https://github.com/LuLAreyu/RemakeBot/network/members)\n \n"
    )
...
async def okgoogle(img):
    ...
    if message and message.media:
        ...
        await img.edit("`Where is the photo.`")
        return
    ...
    if photo:
        ...
        try:
            ...
            await img.edit('`Gambar tidak di dukung, Sorry!!.`')
            return
        name = "okgoogle.png"
        image.save(name, "PNG")
        image.close()
